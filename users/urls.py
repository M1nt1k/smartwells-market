...
from .keycloak_views import keycloak_callback, keycloak_login, keycloak_logout
...
urlpatterns = [
    ...
    # keycloak part
    path('oauth/login/', keycloak_login, name='keycloak_login'),
    path('oauth/logout/', keycloak_logout, name='keycloak_logout'),
    path('oauth/callback/', keycloak_callback, name='keycloak_callback'),
]
